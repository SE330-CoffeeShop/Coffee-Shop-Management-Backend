        ...
        if (coffeeCategory != null) {
            ...
            coffeeNameAndUrl.forEach((name, url) -> {
                ...
                products.add(Product.builder()
                        ...
                        .productRatingsAverage(BigDecimal.valueOf(4.5))
        ...
        if (freezeCategory != null) {
            ...
            freezeNameAndUrl.forEach((name, url) -> {
                ...
                products.add(Product.builder()
                        ...
                        .productSlug(slug)
                        .productCommentCount(3)
                        .productRatingsAverage(BigDecimal.valueOf(4.6))
                        .productIsPublished(true)
                        .productIsDeleted(false)
        ...
        if (teaCategory != null) {
            ...
            teaNameAndUrl.forEach((name, url) -> {
                ...
                products.add(Product.builder()
                        ...
                        .productSlug(slug)
                        .productCommentCount(3)
                        .productRatingsAverage(BigDecimal.valueOf(4.7))
                        .productIsPublished(true)
                        .productIsDeleted(false)
        ...
        if (foodCategory != null) {
            ...
            foodNameAndUrl.forEach((name, url) -> {
                ...
                products.add(Product.builder()
                        ...
                        .productSlug(slug)
                        .productCommentCount(3)
                        .productRatingsAverage(BigDecimal.valueOf(4.8))
                        .productIsPublished(true)
                        .productIsDeleted(false)
        ...
        if (otherCategory != null) {
            ...
            otherNameAndUrl.forEach((name, url) -> {
                ...
                products.add(Product.builder()
                        ...
                        .productSlug(slug)
                        .productCommentCount(3)
                        .productRatingsAverage(BigDecimal.valueOf(4.9))
                        .productIsPublished(true)
                        .productIsDeleted(false)
